...
export const Header = () => {
    ...
    return (
        <>
            <header className='bg-red-700 text-amber-100 flex text-4xl font-bold p-4 shadow-md shadow-amber-900'>
                <div className='w-full flex justify-start'>
                    <a href="https://www.github.com/alexanderrjstj" className='flex items-center' target='_blank'>
