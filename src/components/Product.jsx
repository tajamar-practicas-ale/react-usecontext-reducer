...
const Product = ({ product }) => {
    ...
    return (
        <div className='border-2 border-red-700 rounded-lg p-4 flex flex-col'>
            ...
            <button className='bg-red-700 hover:bg-red-600 cursor-pointer p-4 text-white font-bold transition-all duration-200 ease-in-out' onClick={() => addItem(product)}>Agregar al carrito</button>
        </div>
    );
};
